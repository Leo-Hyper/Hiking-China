...
## Current Status
**Phase:** Phase 8.1 资源上线准备完成，待设置 Turso 凭据导入并部署。
...
## Active Tasks
- 设置 TURSO_DATABASE_URL/TURSO_AUTH_TOKEN 后执行 migrate:check 与 migrate:apply
- 推送提交触发 Render/Netlify 部署，验证线上帖子、图片和 logo
