...
const objCode = 'const postContents = ' + raw.slice(start + 'export const postContents = '.length, end + 1);

// 安全执行
const postContents = vm.runInNewContext(objCode, { console }).postContents;
